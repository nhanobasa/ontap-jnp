 ...
 * generated in the productservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetProduct_QNAME = new QName("http://ProductService/", "getProduct");
    private final static QName _GetProductResponse_QNAME = new QName("http://ProductService/", "getProductResponse");
    private final static QName _InsertProductResponse_QNAME = new QName("http://ProductService/", "insertProductResponse");
    private final static QName _InsertProduct_QNAME = new QName("http://ProductService/", "insertProduct");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: productservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ProductService/", name = "getProduct")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ProductService/", name = "getProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ProductService/", name = "insertProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ProductService/", name = "insertProduct")
