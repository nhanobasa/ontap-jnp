 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://ProductService/", wsdlLocation = "http://26.236.58.26:8080/ExamService/ProductService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://ProductService/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://26.236.58.26:8080/ExamService/ProductService?wsdl");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://ProductService/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ProductService/", "ProductServicePort"), ProductService.class, features);
    }
